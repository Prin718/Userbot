...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        f"** ⎯꯭֯🖤⃪ ꯭⃛֯ ̶̲̽͟𓆩⃪ͥ͢ ᷟ𓆩𝙍𝘼𝘿𝙃𝙀 ⃪𝄀꯭𝄄꯭ا✾༐𓂃⃪꯭,, ㅤ ™  **\n\n"
        f"❏ **𝐕ᴇʀsɪᴏɴ**: `2.1`\n"
        f"├• **𝐔ᴘᴛɪᴍᴇ**: `{str(datetime.now() - START_TIME).split('.')[0]}`\n"
        f"├• **𝐏ʏᴛʜᴏɴ**: `{python_version()}`\n"
        f"├• **𝐏ʏʀᴏɢʀᴀᴍ**: `{__version__}`\n"
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [⎯꯭֯🖤⃪ ꯭⃛֯ ̶̲̽͟𓆩⃪ͥ͢ ᷟ𓆩𝙍𝘼𝘿𝙃𝙀 ⃪𝄀꯭𝄄꯭ا✾༐𓂃⃪꯭,, ㅤ ™](t.me/BOT_SUPPORT_GROUP7)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: ⎯꯭֯🖤⃪ ꯭⃛֯ ̶̲̽͟𓆩⃪ͥ͢ ᷟ𓆩𝙍𝘼𝘿𝙃𝙀 ⃪𝄀꯭𝄄꯭ا✾༐𓂃⃪꯭,, ㅤ ™](t.me/ll_BOTCHAMBER_ll)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [⎯꯭֯🖤⃪ ꯭⃛֯ ̶̲̽͟𓆩⃪ͥ͢ ᷟ𓆩𝙍𝘼𝘿𝙃𝙀 ⃪𝄀꯭𝄄꯭ا✾༐𓂃⃪꯭,, ㅤ ™](t.me/ll_RADHE7_ll)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("SORRY MERI JAAN REPO CHAHIYE TO DM KAR LO @ll_RADHE7_ll")
